...
Offering.create!(user_id: User.first.id, title: "Beautiful view appartment in the heart of Amsterdam", available: true,
  description: "Beautiful 4 bedrooms appartment for a big family, pets allowed, with balcony", property_type: "Appartment",average_rating: 4, price_per_night: 29.99, address:"Keizersgracht 609, 1017 DS", city: "Amsterdam", country: "Netherlands", size:8)
Offering.create!(user_id: User.first.id, title:"Noordwijk, let's have some fun!",available: true,
  description: "Beautiful 2 bedrooms appartment for a big family,pets not allowed", property_type: "Appartment", average_rating: 5, price_per_night: 300.0, address:"Spaarne 16, 2011 CH", city: "Haarlem", country: "Netherlands", size:12)
